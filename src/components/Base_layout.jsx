...
import User_ChangePassword from "../container/Users_ChangePassword";
...
const UserCenter = (
  <div>
    <SubMenu title="个人中心">
      <Menu.Item key="User_ChangePassword">
        <Link to="/User_ChangePassword">修改密码</Link>
      </Menu.Item>
      <Menu.Item onClick={passport.quit} key="Quit">
...
const Menubar = withRouter(({ history }) => {
  ...
  return (
    ...
    >
      ...
      {passport.isAdmin ? (
        <SubMenu title="管理" key="manage">
          <Menu.Item key="Challenge_Mange">
            <Link to="/Mange_Challenge">实验管理</Link>
          </Menu.Item>
          <Menu.Item key="Container_Manage">
            <Link to="/Mange_Container">容器管理</Link>
          </Menu.Item>
          <Menu.Item key="Users_Manage">
            <Link to="/Mange_Users">用户管理</Link>
          </Menu.Item>
        </SubMenu>
      ) : (
        ""
      ...
      <Layout>
        <Router>
          <Header style={{ position: "fixed", zIndex: 1, width: "100%" }}>
            <div className="logo">
              <img
                style={{ position: "fixed", margin: "0px 35px 0 " }}
          ...
          >
            ...
            >
              ...
              <Route path="/User_ChangePassword" component={User_ChangePassword} />
            </div>
          </Content>
        </Router>
